...
> **safe.3 内置 4060 Laptop 保守试用预设，已在本机 / 616.64 验证整段曲线应用、手动恢复及 60 秒超时恢复；长期游戏稳定性未验证。**
...
- **显存锁频档位** — 驱动报告的离散频率，修复 8001～8001 滑块卡住；写入支持仍由驱动决定，不是显存超频偏移
- **V/F 曲线（实验性）** — 原生点选择、平台预览、4060 Laptop 保守预设、60 秒试用、原偏移备份及恢复；不是硬电压锁，不承诺通用稳定
